...
- **Current receiver:** [deployment bundle](../contracts/aqua-executor/deployments/11155111.json) points to Guard V2 `0xfadc3165abeb127a0815d5ea4e2862ed430e1f70`, revision `maker-active-v1`, **CRE simulation** profile. [Replacement deployment proof](../contracts/aqua-executor/docs/ethereum-sepolia-guard-revision.json). Do not reuse the older `0x51c4…356e` receiver for Maker-scoped switching.
...
- **Still to verify:** public Maker A/B switching; complete frontend/runner lifecycle; actual DON deployment and confidential TEE delivery. CLI simulation, DON deploy access and Confidential Workflows enrollment are separate states.
