...
with sync_playwright() as p:
    ...
    expect(page.get_by_role('heading', name='Build from a plain-language brief.')).to_be_visible()
    ...
    heading = page.get_by_role('heading', name='Build from a plain-language brief.')
